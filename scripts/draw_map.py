...
if __name__ == "__main__":
    ...
    natura2000 = gpd.read_file(snakemake.input.path_natura2000)

    boundaries_eez = gpd.read_file(snakemake.input.path_boundaries_eez)
    boundaries_onshore = gpd.read_file(snakemake.input.path_boundaries_onshore)

    water_depth = xr.open_dataset(snakemake.input.path_water_depth)
    ...
    plt.savefig(snakemake.output[0], dpi=300, bbox_inches="tight", transparent=False)
